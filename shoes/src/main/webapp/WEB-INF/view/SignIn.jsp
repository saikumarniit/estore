...
<div class="container">
  ...
  <ul class="nav nav-pills">
    ...
    <div align="center" class="form">
        <form:form action="./SignIn" method="post" id="contactform" style="background-color:black">
            <table border="0">
                <tr>
                    <td colspan="2" align="center"><h2 style="color: white">Sign In Here</h2></td>
                </tr>
                <tr>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><form:password path="password"  placeholder="Password" required="true" style="width:300px"/></td>
                        ...
                        <tr>
                    <td colspan="2" class="buttom" id="submit" align="center"><input id="submit" type="submit" value="SignIn" style="color:white" /></td>
                </tr>
            </table>
        </form:form>
    </div>
