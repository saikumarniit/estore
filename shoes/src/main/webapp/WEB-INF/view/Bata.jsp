...
<div class="container">
 ...
 <div>
 <center><h3 style="color: black;">Lee Cooper</h2></center>
 </div>
  <hr>
  </div>
...
<img border="0" alt="W3Schools" src="<c:url value="/resources/images/{{ resource.id}}.jpg"/>" width="200" height="150">

</a></td>
<td>INR {{resource.price}}</td>
        </tr>    
    </table>

<script>
angular.module('myApp', []).controller('namesCtrl', function($scope) {
    $scope.names = ${productsdata};
